	...
	<section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10">
		...
		<div class="w-full md:w-1/3 text-left">
			...
			<p
				...
				Inquisitive Full-Stack Developer & Aspiring Hacker
			</p>
			<p
				class="font-general-medium mt-2 text-lg sm:text-xl  xl:text-2xl text-center sm:text-left leading-none text-gray-400">
				Writing Code, Chasing Bugs, Shaking My Head, and Laughing It Off 😂😂😂😂 </p>
			<div class="flex sm:block">
				<a href="https://www.canva.com/design/DAFxz-2uyr8/rpA89lsPWfu6pYZf7UoRbg/edit?utm_content=DAFxz-2uyr8&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" target="__blank"
